...
/**
 * Wrapped version of "Criteria" class, that injects a tenantId expression onto each query.  Provided by {@link InterceptableSession}
 */
public class InterceptableCriteria implements Criteria {
// ========================================================================================================================
//    Instance Fields
// ========================================================================================================================
...
// ========================================================================================================================
    ...
    public InterceptableCriteria(Criteria wrappedCriteria, EventBroker eventBroker) {
        this.wrappedCriteria = wrappedCriteria;
        eventBroker.publish("hibernate.criteriaCreated", this);
    }
