 ...
 * making sure to include the tenantId).  Provided by {@link InterceptableSession}
 */
public class InterceptableQuery implements Query {
// ========================================================================================================================
//    Instance Fields
// ======================================================================================================================== 
...
// ========================================================================================================================
    ...
    public InterceptableQuery(Query wrapped, EventBroker eventBroker) {
        this.wrapped = wrapped;
        eventBroker.publish("hibernate.queryCreated", this);
    }
